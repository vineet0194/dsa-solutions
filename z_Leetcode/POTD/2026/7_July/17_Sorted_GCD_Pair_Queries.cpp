...
Link: https://leetcode.com/problems/sorted-gcd-pair-queries/description/?envType=daily-question&envId=2026-07-17
Difficulty: Hard
Approach: Divisor Counting + Inclusion-Exclusion + Prefix Sum + Binary Search
Time Complexity: O(N * sqrt(M) + M * log M + Q * log M)
Note:
